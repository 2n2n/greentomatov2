				...
				<?php if(have_posts()): 
					...
					<li>
						<div class="wedding-left wedding-inner fl">
							<h2>WEDDINGS</h2>
							<div class="wedding-post-video img fl"><a class="video-popup" href="#animatedModal"><img src="<?php echo get_template_directory_uri(); ?>/images/home/wedding_post.jpg" width="620" height="349" alt="" title=""/></a></div>
						</div>
